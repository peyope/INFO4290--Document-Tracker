...
\restrict RD3PusOuLY3Ltw719mR6rJ8O8H2R7d4t6nDNnyd2uIAdzHa8tuQs2hTEVSh1SCT
...
ALTER TABLE ONLY public.document_audit_log
    ADD CONSTRAINT document_audit_log_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES public.users(id) ON DELETE RESTRICT;
...
\unrestrict RD3PusOuLY3Ltw719mR6rJ8O8H2R7d4t6nDNnyd2uIAdzHa8tuQs2hTEVSh1SCT
